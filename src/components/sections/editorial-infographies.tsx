...
export function EditorialInfographies() {
  return (
    <section id="infografias" className="py-16 md:py-24 bg-[#FBF9F5] border-b border-[#D8D2C5] scroll-mt-14 font-sans">
      ...
      <Container className="max-w-[1340px] space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-baseline justify-between gap-2 pb-3 border-b border-[#D8D2C5]">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl sm:text-3xl text-stone-950 font-medium tracking-tight">
        ...
        <p className="text-sm sm:text-base text-stone-600 text-center max-w-3xl mx-auto leading-relaxed">
